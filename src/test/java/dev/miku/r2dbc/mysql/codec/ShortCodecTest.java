 ...
 */
class ShortCodecTest extends NumericCodecTestSupport<Short> {
    ...
    public ByteBuf[] binaryParameters(Charset charset) {
        return Arrays.stream(shorts).map(LongCodecTest::convert).toArray(ByteBuf[]::new);
    }
