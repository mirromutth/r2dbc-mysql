 ...
 */
final class InstantCodec extends AbstractClassedCodec<Instant> {

    InstantCodec(ByteBufAllocator allocator) {
        super(allocator, Instant.class);
    }
    ...
    private static final class InstantParameter extends AbstractParameter {
        ...
        public Mono<ByteBuf> publishBinary() {
            return Mono.fromSupplier(() -> LocalDateTimeCodec.encodeBinary(allocator, LocalDateTime.ofInstant(value, context.getServerZoneId())));
        }

        @Override
        public Mono<Void> publishText(ParameterWriter writer) {
            return Mono.fromRunnable(() -> LocalDateTimeCodec.encodeText(writer, LocalDateTime.ofInstant(value, context.getServerZoneId())));
        }
