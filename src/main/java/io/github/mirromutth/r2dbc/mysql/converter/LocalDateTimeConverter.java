 ...
 */
final class LocalDateTimeConverter extends AbstractClassedConverter<LocalDateTime> {
    ...
    @Override
    public LocalDateTime read(ByteBuf buf, boolean isUnsigned, int precision, int collationId, Class<? super LocalDateTime> target, MySqlSession session) {
